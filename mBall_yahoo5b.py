...
def main():
    ...
    engine = create_engine(
        'postgresql://postgres:[PASSWORD_MASKED]@localhost:5432/scraping'.format(**connection_config))
...
#         pd.DataFrame, expand='table', index=False, header=None).value = grouped.iloc[:, 1:8] # mergeの１－７列目に画像URLがある。8, 9 まであるアイテムも。
    ...
    # macro()
    # shutil.move('C:/Users/[USERNAME_MASKED]/Desktop/00.Myself/04.Buyer/1.利益計算/db_check_yahoo3.txt',
    ...
    # pr_csv = 'C:/Users/[USERNAME_MASKED]/Desktop/00.Myself/04.Buyer/1.利益計算/db_check_yahoo4.csv'
